...
This program is written in C. To compile and run the source code, enter the command:
"make run". Then, input the number of pigeons and holes. The program will then write the output into the "output files" folder and the standard output. The name of the .txt files inside the "output files" are determined by its input n and m.
